...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '4959209c-d4e8-11f0-971f-f63833571e91:1-73';
...
INSERT INTO `actors_has_movies` VALUES (2,1),(3,2),(1,3);
...
INSERT INTO `movies` VALUES (1,'La vita è bella','Comedia','https://pics.filmaffinity.com/la_vita_e_bella-646167341-mmed.jpg','Top 10',1997),(2,'Pulp Fiction','Crimen','https://pics.filmaffinity.com/pulp_fiction-210382116-large.jpg\n\n','Top 10',1994),(3,'Forrest Gump','Comedia','https://pics.filmaffinity.com/forrest_gump-212765827-mmed.jpg\n\n','Top 10',1994);
...
CREATE TABLE `users_has_movies` (
  ...
  CONSTRAINT `fk_users_has_movies_movies1` FOREIGN KEY (`movies_id`) REFERENCES `movies` (`id`),
  CONSTRAINT `fk_users_has_movies_users` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`),
  CONSTRAINT `users_has_movies_chk_1` CHECK ((`score` <= 10))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users_has_movies` VALUES (1,1,NULL),(1,2,NULL),(3,2,NULL);
...
-- Dump completed on 2025-12-12 11:31:13
